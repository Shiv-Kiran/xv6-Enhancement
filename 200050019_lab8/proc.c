...
int clone2(void (*fcn)(void *, void *), void *arg1, void *arg2, void *stack)
{
  struct proc *np;
...
// Create a new threading copying p as the group id
int clone(void (*func)(int *), int *args, void *stack)
{
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
  ...
  *(uint *)sret = 0xFFFFFFF;
  ...
  // Push first argument to the stack of thread
  sarg1 = stack + PGSIZE - 1 * sizeof(void *);
  *(uint *)sarg1 = (uint)args;
